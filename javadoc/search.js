...
$.widget("custom.catcomplete", $.ui.autocomplete, {
    _create: function() {
        this._super();
        this.widget().menu("option", "items", "> :not(.en.ubb.pet_shop.core.client.ui-autocomplete-category)");
    },
    _renderMenu: function(ul, items) {
        ...
        $.each(items, function(index, item) {
            ...
            if (item.category && item.category !== currentCategory) {
                ul.append("<li class=\"en.ubb.pet_shop.core.client.ui-autocomplete-category\">" + item.category + "</li>");
